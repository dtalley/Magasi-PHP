...
#
class phpass {
	private static $itoa64;
	private static $iteration_count_log2;
	private static $portable_hashes;
	...
	private static function initialize() {
		if( !self::$initialized ) {
			...
			self::$iteration_count_log2 = 8;
			self::$portable_hashes = FALSE;
	
			self::$random_state = microtime() . getmypid();
